...
import Card from './CardContact.css';
import DeleteModal from './DeleteModal';
import axios from "axios";
import {  useDispatch } from "react-redux";
import { getContact ,deleteContact} from "../redux/Contact/Action";
...
const [sending,setSending]=useState(false)
  ...
  return (
   ...
   <p> { props.item.nom}: الإسم</p>

   <p> { props.item.email}:بريد إلكتروني</p>
   <p>  { props.item.telephone}: رقم الهاتف</p>

   <p><button className="btnCard"
   onClick={
    () => {tog_delete(true);
